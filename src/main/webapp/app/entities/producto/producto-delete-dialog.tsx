...
export const ProductoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="finalProgramacion2App.producto.delete.question">
        <Translate contentKey="finalProgramacion2App.producto.delete.question" interpolate={{ id: productoEntity.id }}>
