  ...
  return (
    <div>
      <h2 id="producto-heading" data-cy="ProductoHeading">
        <Translate contentKey="finalProgramacion2App.producto.home.title">Productos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="finalProgramacion2App.producto.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="finalProgramacion2App.producto.home.createLabel">Create new Producto</Translate>
          </Link>
        </div>
      </h2>
          ...
          {productoList && productoList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="finalProgramacion2App.producto.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="finalProgramacion2App.producto.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="finalProgramacion2App.producto.descripcion">Descripcion</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('precio')}>
                    <Translate contentKey="finalProgramacion2App.producto.precio">Precio</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('cantVendida')}>
                    <Translate contentKey="finalProgramacion2App.producto.cantVendida">Cant Vendida</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="finalProgramacion2App.producto.distribuidor">Distribuidor</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="finalProgramacion2App.producto.home.notFound">No Productos found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
