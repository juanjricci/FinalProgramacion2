  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="finalProgramacion2App.producto.home.createOrEditLabel" data-cy="ProductoCreateUpdateHeading">
            <Translate contentKey="finalProgramacion2App.producto.home.createOrEditLabel">Create or edit a Producto</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('finalProgramacion2App.producto.nombre')}
                id="producto-nombre"
                name="nombre"
                data-cy="nombre"
                type="text"
              />
              <ValidatedField
                label={translate('finalProgramacion2App.producto.descripcion')}
              ...
              />
              <ValidatedField
                label={translate('finalProgramacion2App.producto.precio')}
                id="producto-precio"
                name="precio"
                data-cy="precio"
                type="text"
              />
              <ValidatedField
                label={translate('finalProgramacion2App.producto.cantVendida')}
              ...
              <ValidatedField
                ...
                label={translate('finalProgramacion2App.producto.distribuidor')}
                type="select"
              >
                <option value="" key="0" />
                {distribuidors
