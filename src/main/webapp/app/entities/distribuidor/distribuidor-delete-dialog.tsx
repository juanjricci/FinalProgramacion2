...
export const DistribuidorDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="finalProgramacion2App.distribuidor.delete.question">
        <Translate contentKey="finalProgramacion2App.distribuidor.delete.question" interpolate={{ id: distribuidorEntity.id }}>
