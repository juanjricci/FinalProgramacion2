    ...
    <Row>
      <Col md="8">
        <h2 data-cy="distribuidorDetailsHeading">
          <Translate contentKey="finalProgramacion2App.distribuidor.detail.title">Distribuidor</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nombre">
              <Translate contentKey="finalProgramacion2App.distribuidor.nombre">Nombre</Translate>
            </span>
          </dt>
