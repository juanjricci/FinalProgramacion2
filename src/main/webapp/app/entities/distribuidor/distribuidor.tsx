  ...
  return (
    <div>
      <h2 id="distribuidor-heading" data-cy="DistribuidorHeading">
        <Translate contentKey="finalProgramacion2App.distribuidor.home.title">Distribuidors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="finalProgramacion2App.distribuidor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="finalProgramacion2App.distribuidor.home.createLabel">Create new Distribuidor</Translate>
          </Link>
        </div>
      </h2>
          ...
          {distribuidorList && distribuidorList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="finalProgramacion2App.distribuidor.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="finalProgramacion2App.distribuidor.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="finalProgramacion2App.distribuidor.descripcion">Descripcion</Translate>{' '}
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="finalProgramacion2App.distribuidor.home.notFound">No Distribuidors found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
