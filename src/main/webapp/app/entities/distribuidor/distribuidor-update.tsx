  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="finalProgramacion2App.distribuidor.home.createOrEditLabel" data-cy="DistribuidorCreateUpdateHeading">
            <Translate contentKey="finalProgramacion2App.distribuidor.home.createOrEditLabel">Create or edit a Distribuidor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('finalProgramacion2App.distribuidor.nombre')}
              ...
              />
              <ValidatedField
                label={translate('finalProgramacion2App.distribuidor.descripcion')}
